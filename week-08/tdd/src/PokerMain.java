...
public class PokerMain {
  ...
  public Object getPairs(List<Card> deckOne, List<Card> deckTwo) {
    ...
    if ((int)deckOneFiltered.get(0) > (int)deckTwoFiltered.get(0)) {
      String resultBlack = convertIntValue((int)deckOneFiltered.get(0));
      System.out.println("Black wins! - (Pair :" + resultBlack + ")");
      return resultBlack;
    }
    String resultWhite = convertIntValue((int)deckTwoFiltered.get(0));
    System.out.println("White wins! - (Pair : " + resultWhite + ")");
    return resultWhite;
  }

  public String convertIntValue(int value)  {
    if (value == 11)  {
      return "J";
    }else if (value == 12) {
      return "Q";
